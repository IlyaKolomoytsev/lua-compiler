...
#define DOT_ARC_THIS_OTHER_LABEL(other, label) \
    DOT_ARC_NODE_ID_WITH_LABEL(this, other, label)
...
#define DOT_NODE_THIS_WITH_LABEL(label) \
    DOT_NODE_WITH_ID_WITH_LABEL(this, label)
